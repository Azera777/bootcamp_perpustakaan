...
Route::prefix('siswa')->middleware('auth:siswa')->group(function() {
    Route::get('/dashboard', [TransaksiController::class, 'index_get_siswa'])->name('dashboard_siswa');
    Route::get('/trx', [TransaksiController::class, 'pinjam_buku_view'])->name('pinjam_buku');
    Route::post('/trx/{id}', [TransaksiController::class, 'store'])->name('store_trx');
});
